...
private:
    ...
    static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
        auto app = reinterpret_cast<HelloRectangleApplication*>(glfwGetWindowUserPointer(window));
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("../workdir/shaders/vert.spv");
        auto fragShaderCode = readFile("../workdir/shaders/frag.spv");
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("../workdir/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
